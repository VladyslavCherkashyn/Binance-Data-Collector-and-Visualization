...
class App:
    def __init__(self):
        ...
        self.csv_file = os.path.join(
            os.path.dirname(__file__), "crypto_info", "data.csv"
        )
    ...
    def save_to_database(self, symbol, interval, candlestick_data):
        ...
        try:
            self.cur.executemany(
                "INSERT INTO candlestick_data (symbol, interval, timestamp, open, high, low, close) "
    ...
    def get_candlestick_data(self, symbol, interval):
        ...
        candles = self.client.get_klines(symbol=symbol, interval=interval, limit=30)
    ...
    def save_data_periodically(self, symbol, interval, save_interval, scheduler):
        ...
        scheduler.enter(
            ...
            argument=(symbol, interval, save_interval, scheduler),
        )
    ...
    def run(self):
        ...
        def index():
            ...
            candlestick_data = self.get_candlestick_data(
                symbol, self.symbol_interval_mapping[symbol]
            )
